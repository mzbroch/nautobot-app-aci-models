"""Unit tests for nautobot_app_cisco_sdn."""
...
class ApplicationProfileAPITest(TestCase):
    ...
    def test_application_profile_list(self):
        ...
        url = reverse("plugins-api:nautobot_app_cisco_sdn-api:applicationprofile-list")
...
class BridgeDomainAPITest(TestCase):
    ...
    def test_application_profile_list(self):
        """Verify that Application Profiles can be listed."""
        url = reverse("plugins-api:nautobot_app_cisco_sdn-api:bridgedomain-list")
        response = self.client.get(url)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.data["count"], len(fixtures.APP_NAMES))
...
class EPGAPITest(TestCase):
    ...
    def test_application_profile_list(self):
        """Verify that Application Profiles can be listed."""
        url = reverse("plugins-api:nautobot_app_cisco_sdn-api:epg-list")
        response = self.client.get(url)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.data["count"], len(fixtures.APP_NAMES))
...
class ApplicationTerminationAPITest(TestCase):
    ...
    def test_application_profile_list(self):
        """Verify that Application Profiles can be listed."""
        url = reverse("plugins-api:nautobot_app_cisco_sdn-api:applicationtermination-list")
        response = self.client.get(url)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.data["count"], len(fixtures.APP_NAMES))
