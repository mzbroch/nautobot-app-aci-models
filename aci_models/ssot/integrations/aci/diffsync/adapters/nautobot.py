...
class NautobotAdapter(Adapter):
    ...
    def load_tenants(self):
        ...
        for nbtenant in Tenant.objects.filter(tags=self.controller_tag):
            _tenant = self.tenant(
                name=nbtenant.name,
    ...
    def load_vrfs(self):
        ...
        for nbvrf in VRF.objects.filter(tags=self.controller_tag):
            _vrf = self.vrf(
                name=nbvrf.name,
    ...
    def load_interfacetemplates(self):
        ...
        for nbinterfacetemplate in InterfaceTemplate.objects.filter(tags=self.controller_tag):
    ...
    def load_interfaces(self):
        ...
        for nbinterface in Interface.objects.filter(tags=self.controller_tag):
    ...
    def load_devices(self):
        ...
        for nbdevice in Device.objects.filter(tags=self.controller_tag):
            _device = self.device(
                name=nbdevice.name,
    ...
    def load_ipaddresses(self):
        ...
        for nbipaddr in IPAddress.objects.filter(tags=self.controller_tag):
    ...
    def load_prefixes(self):
        ...
        for nbprefix in Prefix.objects.filter(tags=self.controller_tag):
    ...
    def load_appprofiles(self):
        """Method to load VRFs from Nautobot."""
        for nbap in ApplicationProfile.objects.filter(tags=self.controller_tag):
    ...
    def load_bridgedomains(self):
        ...
        for nbbd in BridgeDomain.objects.filter(tags=self.controller_tag):
    ...
    def load_epgs(self):
        ...
        for nbepg in EPG.objects.filter(tags=self.controller_tag):
            _epg = self.aci_epg(
                name=nbepg.name,
    ...
    def load_appterminations(self):
        ...
        for nbepgpath in ApplicationTermination.objects.filter(tags=self.controller_tag):
