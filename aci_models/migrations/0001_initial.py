    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tenant",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, related_name="aci_appprofiles", to="tenancy.tenant"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ip_addresses",
                    models.ManyToManyField(blank=True, related_name="aci_bridgedomains", to="ipam.IPAddress"),
                ),
                ("tags", nautobot.core.models.fields.TagsField(through="extras.TaggedItem", to="extras.Tag")),
                (
                    "tenant",
                ...
                (
                    "vrf",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, related_name="aci_bridgedomains", to="ipam.vrf"
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="aci_models.applicationprofile",
                    ),
                ),
                (
                    "bridge_domain",
                ...
                (
                    "tenant",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, related_name="aci_epgs", to="tenancy.tenant"
                    ),
                ),
            ],
            options={
